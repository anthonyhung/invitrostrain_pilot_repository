...
set.seed(1)
topic_colors <- c("grey", "turquoise", "firebrick", "gold","salmon","forestgreen", "turquoise", "royalblue", "black",
                  "orangered")
topics_order <- c(1, 3, 4, 5, 6, 2)
rows_keep <- sort(c(sample(which(sample_labels$Cell.Type == "Hepatocyte"), 800),
               sample(which(sample_labels$Cell.Type == "iPSC"), 800),
               sample(which(sample_labels$Cell.Type == "iPSC-MSC"), 800),
               which(sample_labels$Cell.Type == "iPSC-Chondrocyte"),
...
set.seed(1)
topic_colors <- c("firebrick", "forestgreen","black","royalblue","grey", "turquoise", "salmon", "gold",
                  "orangered")
topics_order <- c(5, 1, 8, 7, 2, 3, 4, 6)
rows_keep <- sort(c(sample(which(sample_labels$Cell.Type == "Hepatocyte"), 800),
               sample(which(sample_labels$Cell.Type == "iPSC"), 800),
               sample(which(sample_labels$Cell.Type == "iPSC-MSC"), 800),
               which(sample_labels$Cell.Type == "iPSC-Chondrocyte"),
