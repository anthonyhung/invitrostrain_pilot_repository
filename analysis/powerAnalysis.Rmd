...
```{r rhinovirus}
rhinovirus_data <- as.tibble(read.table("data/caliskan_etal/eQTL_results_cis_response.txt.gz", 
                              sep = "\t",
                              header = TRUE))
...
# saveRDS(rhinovirus_f_ashr_out, "output/ash_power_analysis/rhinovirus_f_ash_out.rds")
rhinovirus_f_ashr_out <- readRDS("output/ash_power_analysis/rhinovirus_f_ash_out.rds")
# rhinovirus_r_ashr_out <- ash(betahat = rhinovirus_data_r$beta, sebetahat = rhinovirus_data_r$se, df = 96)
# saveRDS(rhinovirus_r_ashr_out, "output/ash_power_analysis/rhinovirus_r_ash_out.rds")
rhinovirus_r_ashr_out <- readRDS("output/ash_power_analysis/rhinovirus_r_ash_out.rds")
