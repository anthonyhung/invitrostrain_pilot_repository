...
GH_iPSC <- readRDS("data/external_scRNA/gh_ipsc.rds")
GH_iPSCMSC <- readRDS("data/external_scRNA/gh_msc.rds")
GH_iPSCChond <- readRDS("data/external_scRNA/gh_ipscChond.rds")
GH_iPSCOsteo <- readRDS("data/external_scRNA/gh_ipscOsteo.rds")
